...
content_goal: Kết quả quan sát được sau khi người ta đọc/xem — không phải 'nâng nhận diện'
audience_profile: Ai, trình độ nào, đang kẹt ở đâu
core_brief: 'Vấn đề → insight → thông điệp → luận điểm chính → phản biện đã lường trước → CTA.

  '
key_sources: Nguồn dự kiến. Bản đã đối chiếu nằm ở mục Nguồn bên dưới.
target_keyword: Một keyword, đúng ý định tìm kiếm
creative_direction: Đã cân nhắc ≥3 hướng, chọn hướng nào, vì sao
constraints: Claim bị cấm, ràng buộc bản quyền, dữ liệu nhạy cảm
content_relationship: Thuộc series nào, nối bài nào trước, dẫn sang bài nào sau
audio: 'yes'
video: 'yes'
short: 'no'
notes: ''
---
# research.md — GTX-003 · Chúng tôi bỏ Excel làm nguồn sự thật — và đây là cái đã sai trước đó
